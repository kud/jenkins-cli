...
const ICON_FALLBACK = { '✅': '[OK]', '❌': '[X]', '⚠️': '[!]', '✂️': '[CUT]', '⏰': '[T]', '💥': '[ERR]', '📄': '[F]', '🏷️': '[TAG]', '💻': '[CMD]', '🐳': '[DOCKER]', '🔧': '[FIX]', '🔀': '[MERGE]', '🔄': '[...]', '📥': '[DL]', '📁': '[DIR]', '🔨': '[BUILD]', '🔍': '[SRCH]', '⏭️': '[SKIP]', '📌': '[*]', '✨': '*', '🔥': '[ERR]', '💀': '[FATAL]', '🐛': '[DBG]', '🔗': '[URL]', '⋯': '...', '🎯': '[ROOT]', '📊': '[DATA]' };
...
export function applyEmojiFallback(text) {
    if (DISABLE_UNICODE_ICONS) {
